"""drive_my_controller controller."""
...
if __name__ == "__main__":
    ...
    # get the time step of the current world. (milliseconds)
    timestep = 100
    max_speed = 6.28
    ...
    left_motor = robot.getDevice('left_axle')
    right_motor = robot.getDevice('right_axle')
    ...
    linear_velocity = wheel_radius * 2 * 3.14159
    
    duration_side = length_side/linear_velocity
    
    start_time = robot.getTime()
    
    angle_of_rotation = (2 * 3.14159) / num_side
